...
class Movimientod_model extends CI_Model
{
	public $table = "movimientos_detalle";
	public $table_id = "id";
	...
	{
		$this->db->from($this->table)->where(array("idmovimiento"=>$id));
