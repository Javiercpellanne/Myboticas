                ...
                <div class="col-sm-6">
                      ...
                      <tbody id="grilla">
                        ...
                        <?php foreach ($detalles as $detalle): ?>
                          ...
                          <tr id="item<?php echo $i; ?>">
                            ...
                            <td><a href="javascript:void(0)" class="btn btn-danger btn-sm py-0" onclick="borrarCotizacion('<?php echo base_url(); ?>cotizacion/cotizaciond/<?php echo $detalle->id; ?>','item<?php echo $i; ?>')" title="Eliminar"><i class="fa fa-trash"></i></a></td>
                          </tr>
                          <?php $i++; ?>
                        <?php endforeach ?>
                      </tbody>
                  ...
                  <table>
                    <tr>
                      ...
                      <td width="29%">
                        <h4><input name="totalg" type="text" id="totalg" class="campo text-right" value="<?php echo $datos->total; ?>"/></h4>
                      </td>
                    </tr>
                  </table>
                </div>
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group row mb-2 mt-2">
                    ...
                    <div class="col-sm-3 col-6">
                      <input name="tvalidez" type="text" id="tvalidez" class="form-control form-control-sm" value="<?php echo $datos->tvalidez; ?>">
                    </div>

                    <label for="tentrega" class="col-sm-3 col-6 control-label">Tiempo Entrega</label>
                    <div class="col-sm-3 col-6">
                      <input name="tentrega" type="text" id="tentrega" class="form-control form-control-sm" value="<?php echo $datos->tentrega; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-9">
                      <input name="dadicional" type="text" id="dadicional" value="<?php echo $datos->dadicional; ?>" class="form-control form-control-sm"/>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group row mb-2 mt-2">
                    ...
                    <input name="idcliente" id="idcliente" type="hidden" value="<?php echo $datos->idcliente; ?>"/>
                    <input name="tdocumento" id="tdocumento" type="hidden" value="0"/>
                    <div class="col-sm-7">
                      <div class="input-group">
                        <input name="cliente" type="text" id="cliente" class="form-control form-control-sm" value="<?php echo $datos->cliente; ?>" placeholder="Nombre o Razon Social" onkeydown="return false" readonly>
                  ...
                  <div class="form-group row mb-2">
                    <div class="col-sm-2 col-6">
                      <div class="custom-control custom-switch">
                          <input type="checkbox" class="custom-control-input" id="pcredito" name="pcredito" value="1" <?php if ($datos->condicion==2) {echo 'checked';} ?>>
