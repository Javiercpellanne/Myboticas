<?php echo form_open(null,array("class"=>"form-horizontal","name"=>"formdatos", "id"=>"formdatos", "onsubmit"=>"enviodatos('".base_url().$this->uri->uri_string()."');", "autocomplete"=>"off")); ?>
  ...
  <div class="form-group row mb-1">
    ...
    <div class="col-sm-2">
      <select class="form-control form-control-sm" id="tipo" name="tipo" required>
        <?php foreach ($identidades as $identidad): ?>
          <option value="<?php echo $identidad->id; ?>" <?php echo set_value_select($datos,"tipo",$identidad->id,$datos->tdocumento); ?>><?php echo $identidad->descripcion; ?></option>
        <?php endforeach ?>
      </select>
    </div>
    ...
    <div class="col-sm-4">
      <div class="input-group">
        <input type="text" class="form-control form-control-sm" id="documento" name="documento" value="<?php echo set_value_input($datos,'documento',$datos->documento); ?>" autocomplete="off" maxlength="11" required>
  ...
  <div class="form-group row mb-1">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control form-control-sm" id="ncomercial" name="ncomercial" value="<?php echo set_value_input($datos,'ncomercial',$datos->ncomercial); ?>">
    </div>
  </div>
  ...
  <div class="form-group row mb-1">
    <label for="direccion" class="col-sm-3 control-label">Direccion Fiscal*</label>
    <div class="col-sm-9">
