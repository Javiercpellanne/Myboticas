            ...
            <?php echo form_open(base_url()."despacho/guardar",array("name"=>"form1", "id"=>"form1", "autocomplete"=>"off")); ?>
              <div class="row">
                ...
                <div class="form-group col-sm-4 mb-2">
                  ...
                  <input name="idcliente" id="idcliente" type="hidden" value="<?php echo $venta->idcliente ?>" required/>
                  <input name="cliente" type="text" id="cliente" class="form-control form-control-sm" value="<?php echo $venta->cliente ?>" readonly>
                </div>
              ...
              <div class="row">
                  <div class="form-group col-sm-4 mb-2">
                    <label for="descripciont" class="control-label">Descripción de motivo de traslado*</label>
                     <input name="descripciont" type="text" id="descripciont" value="ENVIO DE MERCADERIA" class="form-control form-control-sm" required />
                  </div>
                  <div class="form-group col-sm-2 mb-2">
                  ...
                  <div class="form-group col-sm-4 mb-2">
                    ...
                    <input name="observaciones" type="text" id="observaciones" value="<?php echo $venta->ncomprobante.' '.$venta->serie.'-'.$venta->numero ?>" class="form-control form-control-sm" required />
                  </div>
              </div>
                ...
                <div class="row">
                  <div class="form-group col-sm-2 mb-2">
                    ...
                    <select class="form-control form-control-sm" id="departamentoe" name="departamentoe" onchange="bubicacion('<?php echo base_url(); ?>establecimiento/busProvincia',this.value,'provinciae')" required>
                      <option value="" <?php echo set_value_select($clientes,'departamentoe',"",$clientes->iddepartamento) ?>>::Selecc</option>
                      <?php foreach ($departamentos as $departamento): ?>
                        <option value="<?php echo $departamento->id ?>" <?php echo set_value_select($clientes,'departamentoe',$departamento->id,$clientes->iddepartamento) ?>><?php echo $departamento->descripcion ?></option>
                      <?php endforeach ?>
                    </select>
                  </div>
                  ...
                  <div class="form-group col-sm-2 mb-2">
                    ...
                    <select class="form-control form-control-sm" id="provinciae" name="provinciae" onchange="bubicacion('<?php echo base_url(); ?>establecimiento/busDistrito',this.value,'distritoe')" required>
                      <option value="" <?php echo set_value_select($clientes,"provinciae","",$clientes->idprovincia) ?>>::Selecc</option>
                      <?php foreach ($dprovincias as $provincia): ?>
                        <option value="<?php echo $provincia->id ?>" <?php echo set_value_select($clientes,'provinciae',$provincia->id,$clientes->idprovincia) ?>><?php echo $provincia->descripcion ?></option>
                      <?php endforeach ?>
                    </select>
                  </div>
                  ...
                  <div class="form-group col-sm-3 mb-2">
                    ...
                    <select class="form-control form-control-sm" id="distritoe" name="distritoe" required>
                      <option value="" <?php echo set_value_select($clientes,'distritoe',"",$clientes->iddistrito) ?>>::Selecc</option>
                      <?php foreach ($ddistritos as $distrito): ?>
                        <option value="<?php echo $distrito->id ?>" <?php echo set_value_select($clientes,'distritoe',$distrito->id,$clientes->iddistrito) ?>><?php echo $distrito->descripcion ?></option>
                      <?php endforeach ?>
                    </select>
                  </div>
                  ...
                  <div class="form-group col-sm-5 mb-2">
                    ...
                    <input type="text" class="form-control form-control-sm" id="direccione" name="direccione" value="<?php echo $clientes->direccion ?>" required>
                  </div>
                </div>
              </fieldset>
