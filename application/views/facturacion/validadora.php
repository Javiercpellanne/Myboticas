        ...
        <div class="card card-outline card-primary">
          <div class="card-header py-2">
            <ul class="nav nav-pills">
              <li class="nav-item"><a class="nav-link py-1 border border-info" href="<?php echo base_url(); ?>facturacion/validador">Documentos (Facturas)</a></li>
              ...
              <li class="nav-item"><a class="nav-link py-1 ml-1 active" href="<?php echo base_url(); ?>facturacion/validadora">Anulaciones (Facturas)</a></li>
            </ul>
          </div>
          <div class="card-body p-3">
            ...
            <?php echo form_open(base_url("facturacion/regularizara"),array("class"=>"form-horizontal","name"=>"fvalidador", "id"=>"fvalidador", "autocomplete"=>"off")); ?>
