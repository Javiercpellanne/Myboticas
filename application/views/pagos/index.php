<div class="content-header pb-1">
  <div class="container-fluid">
    <div class="row mb-0">
      <div class="col-sm-6">
        <h4 class="m-0 text-dark">Pagos</h4>
      </div>
      <div class="col-sm-6">
        ...
        <div class="card card-outline card-primary">
          <div class="card-header py-2">
            <ul class="nav nav-pills">
              <li class="nav-item"><a class="nav-link py-1 active" href="<?php echo base_url(); ?>pagos">Efectuados</a></li>
              <li class="nav-item"><a class="nav-link py-1 ml-1 border border-info" href="<?php echo base_url(); ?>pagos/pagar">Cta por Pagar</a></li>
            </ul>
          </div>
            ...
            <table id="sampleTable" class="table table-striped table-bordered table-sm dt-responsive nowrap" style="width:100%">
              ...
              <tbody>
                ...
                <?php foreach ($listas as $lista): ?>
                  <?php $compra=$this->compra_model->mostrar($lista->idcompra); ?>
                  <tr>
                    <td><?php echo $i; ?></td>
                    ...
                    <td>
                      <!-- <button type="button"class="btn btn-success btn-sm py-0" onclick="mostrarModal('<?php echo base_url(); ?>pagos/opciones/<?php echo $lista->id; ?>','bdatos','Opciones Impresion')" title="Impresion" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-print"></i></button> -->
                    </td>
                  </tr>
                  <?php $i++; ?>
                <?php endforeach ?>
