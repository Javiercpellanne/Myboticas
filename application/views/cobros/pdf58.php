...
$pdf->SetFont('dejavusanscondensed','',6.8);
$tblf = '<table cellspacing="0" cellpadding="2" border="0">
    <tr>
        <td width="45%"><b>Fecha de Pago :</b></td>
        <td width="55%">'.$datos->femision.'</td>
    </tr>
    <tr>
    ...
    <tr>
        <td width="45%"><b>Importe Pagado :</b></td>
        <td width="55%" align="right"><b style="font-size: 1.1 em;">S/. '.$datos->total.'</b></td>
    </tr>
    <tr>
    ...
    <tr>
        <td width="67%"><b>Documento de referencia : </b></td>
        <td width="33%">'.$ventas->serie.' - '.$ventas->numero.'</td>
    </tr>';
$tblf .= '</table>';
