...
$tblf = '<table cellspacing="0" cellpadding="2" border="0">
    <tr>
        <td width="27%"><b>Fecha de Pago :</b></td>
        <td width="73%">'.$datos->femision.'</td>
    </tr>
    <tr>
        <td width="27%"><b>Cliente :</b></td>
        <td width="73%">'.$ventas->cliente.'</td>
    </tr>
    <tr>
        <td width="27%"><b>Importe Pagado :</b></td>
        <td width="73%"><b style="font-size: 1.3 em;">S/. '.$datos->total.'</b></td>
    </tr>
    <tr>
    ...
    <tr>
        <td width="27%"><b>Documento de referencia : </b></td>
        <td width="73%">'.$ventas->serie.' - '.$ventas->numero.'</td>
    </tr>';
$tblf .= '</table>';
