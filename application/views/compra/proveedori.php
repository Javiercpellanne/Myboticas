<?php echo form_open(null,array("class"=>"form-horizontal","name"=>"fdatos", "id"=>"fdatos", "onsubmit"=>"envioProveedor('".base_url().$this->uri->uri_string()."');", "autocomplete"=>"off")); ?>
  <div class="form-group row mb-1">
    ...
    <div class="col-sm-2">
        <select class="form-control form-control-sm" id="tipo" name="tipo" required>
          <option value="6" <?php echo set_value_select(6,'tipo',6,6) ?>>RUC</option>
          <option value="1" <?php echo set_value_select(6,'tipo',1,6) ?>>DNI</option>
        </select>
    </div>
    <div class="col-sm-4">
      <div class="input-group">
        <input type="text" class="form-control form-control-sm" id="documento" name="documento" value="" required>
