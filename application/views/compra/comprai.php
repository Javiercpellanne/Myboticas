      ...
      <div class="col-12">
        <div class="card card-outline card-primary">
          <div class="card-body p-3">
            ...
            <?php echo form_open(null,array("class"=>"form-horizontal","name"=>"form1", "id"=>"form1", "autocomplete"=>"off", "onsubmit"=>"return envioFormulario('".base_url()."compra/guardar');")); ?>
              ...
              <div class="form-group row mb-1">
                ...
                <div class="col-sm-10">
                  <input type="text" id="dadicional" name="dadicional" class="form-control form-control-sm" value="">
                </div>
              </div>
              ...
              <table cellpadding="3">
                <tr>
                  ...
                  <td width="10%">
                    ...
                    <h4><input name="subtotal" type="text" id="subtotal" class="campo text-right" value=""/></h4>
                  </td>
                  ...
                  <td width="10%">
                    <h4><input name="total" type="text" id="total" class="campo text-right" value=""/></h4>
                  </td>
