...
define("titulo", 'VENTAS VALORIZADAS DEL '.$inicio.' AL '.$fin.'<br> USUARIO : '.$usuarios->nombres, false);
    ...
    public function Header() {
        ...
        $tblc = '<table cellspacing="0" cellpadding="0" border="0">
            <tr>
                ...
                <td width="70%" align="center" height="48px"><br>'.titulo.'</td>
        ...
        <tr>
            ...
            <th align="center" width="60%"><strong>Producto</strong></th>
...
$tbl = '<table cellspacing="0" cellpadding="2" border="1">';
    ...
    $tbl .= '<tr>
            <td width="5%">'.$i.'</td>
            <td width="60%">'.$lista->descripcion.'</td>
...
$tbl .= '<tr>
            <td align="right" width="74%">Totales</td>
