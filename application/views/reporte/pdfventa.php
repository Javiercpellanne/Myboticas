...
$tblc = '<table cellspacing="0" cellpadding="0" border="0">
    <tr>
        ...
        <td width="70%" align="center" height="48px"><br><br> VENTAS DESDE '.FormatoFecha($this->input->post('cinicio',true)).' AL '.FormatoFecha($this->input->post('cfin',true)).'</td>
...
$tbl = '<table cellspacing="0" cellpadding="1" border="0">
    ...
    if ($this->input->post('ctipo',true)!='C') {
        $i=1;
        $general=0; $tizipay=0;
        foreach ($nventas as $dato) {
            ...
            $tbl .= '<tr>
                ...
                <td width="10%" style="border-top: 1px solid #000;">NOTA DE VENTA</td>
                ...
                <td width="7%" align="right" style="border-top: 1px solid #000;">'.formatoPrecio($dato->izipay).'</td>
                <td width="13%" style="border-right: 1px solid #000; border-top: 1px solid #000;">'.($nombre->nombres??'').'</td>
            </tr>';
            ...
            if ($detallado==1 && $dato->nulo==0) {
                ...
                $tbl .= '<tr>
                        ...
                        <td align="center" width="48%"><strong>Descripcion</strong></td>
        ...
        $tbl .= '<tr>
            <td align="right" width="74%" style="border-top: 1px solid #000;"><strong>Total Nota de Venta</strong></td>
    ...
    if ($this->input->post('ctipo',true)!='N') {
        $i=1;
        $general=0; $tizipay=0;
