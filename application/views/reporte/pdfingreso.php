...
define("fechas", 'DEL '.$this->input->post('iinicio',true).' AL '.$this->input->post('ifin',true), false);
    ...
    public function Header() {
        ...
        $tblc = '<table cellspacing="0" cellpadding="0" border="0">
            <tr>
                ...
                <td width="70%" align="center" height="48px">INGRESOS DE PRODUCTO POR '.motivo.' <br>'.fechas.'</td>
...
$pdf->SetTitle('Ingreso de Producto');
...
$tbl = '<table cellspacing="0" cellpadding="2" border="1">';
    ...
    $tbl .= '<tr>
            ...
            <td width="10%" align="right">'.$dato->entradaf.'</td>
            <td width="10%" align="right">'.$dato->costo.'</td>
            <td width="10%" align="right">'.$dato->entradav.'</td>
            </tr>';
    $i++;
    }
$tbl .= '</table>';
