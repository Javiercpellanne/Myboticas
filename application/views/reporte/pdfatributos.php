...
define("tipo", $buscador.' : ', false);
define("buscador", $nombres->descripcion, false);
    ...
    public function Header() {
        ...
        $tblc = '<table cellspacing="0" cellpadding="0" border="0">
            <tr>
                ...
                <td width="70%" align="center" height="48px">STOCK DE PRODUCTOS AL DIA '.FormatoFecha(date("Y-m-d")).'<br>'.tipo.'<b style="font-size: 0.75 em;">'.buscador.'</b></td>
        ...
        <tr>
            ...
            <th align="center" width="10%"><strong>P. Venta</strong></th>
...
$pdf->SetTitle('Stock por Atributo');
...
$tbl = '<table cellspacing="0" cellpadding="2" border="1">';
    ...
    $tbl .= '<tr>
            ...
            <td width="10%" align="right">'.$pventa.'</td>
            <td width="10%" align="right">'.estadoUsuario($dato->estado).'</td>
            </tr>';
    $i++;
    }
$tbl .= '</table>';
