<?php echo form_open(null,array("class"=>"form-horizontal","name"=>"formdatos", "id"=>"formdatos", "onsubmit"=>"enviodatos('".base_url().$this->uri->uri_string()."');", "autocomplete"=>"off")); ?>
  ...
  <div class="form-group row mb-1">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control form-control-sm" id="licencia" name="licencia" value="<?php echo set_value_input($datos,'licencia',$datos->licencia); ?>" required>
    </div>
  </div>
  ...
  <div class="form-group row mb-1">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control form-control-sm" id="placa" name="placa" value="<?php echo set_value_input($datos,'placa',$datos->placa); ?>" required>
    </div>
  </div>
