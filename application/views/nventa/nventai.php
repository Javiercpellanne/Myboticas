<div class="content-header pb-1">
  <div class="container-fluid">
    <div class="row mb-0">
      <div class="col-sm-6">
        <h4 class="m-0 text-dark">Nota de Venta --- <small class="text-muted" style="font-size: 60%;">Bono Dia : S/. <?php echo $bonodiario->monto ?? 0 ?> | Bono Mensual : S/. <?php echo $bonomensual->monto ?? 0 ?></small> <span class="right badge badge-danger">Sin Stock</span> <span class="right badge bg-purple">Bono</span> <button type="button" class="btn btn-primary btn-sm py-0" onclick="mostrarModal('<?php echo base_url(); ?>nventa/atajos','bdatos','Atajos Teclas')" title="Atajos Teclas" data-toggle="tooltip" data-placement="bottom"><i class="fas fa-keyboard"></i></button></h4>
      </div>
      <div class="col-sm-6">
      ...
      <div class="col-12">
        <div class="card card-outline card-primary">
          <div class="card-body p-2">
            ...
            <?php echo form_open(null,array("class"=>"form-horizontal","name"=>"form1", "id"=>"form1", "autocomplete"=>"off", "onsubmit"=>"return envioVenta('".base_url()."nventa/guardar');")); ?>
              <div class="row">
                <div class="col-sm-6">
                  <div class="row mb-2">
                  ...
                  <div class="table-responsive border border-dark" style="height: 350px; font-size: .79rem">
                      ...
                      <tbody id="tblproducto">
                        <?php foreach ($productos as $producto): ?>
                          ...
                          <tr style="color: <?php echo $color; ?>;" class="<?php echo $tcolor; ?>">
                            ...
                            <td><a href="javascript:void(0)" onclick="mostrarModal('<?php echo base_url(); ?>producto/busProductoLotes/<?php echo $producto->id; ?>','bdatos','Mostrar Producto y Lotes')" class="badge badge-dark" style="font-size: 100%;" title="Seleccionar Lotes"><?php echo $empresa->lstock==1 && $cantidad->stock>99 ? '+99': $cantidad->stock; ?></a></td>
                            <?php else: ?>
                ...
                <div class="col-sm-6">
                  ...
                  <table>
                    <tr>
                      <td width="24%" align="right"><a class="btn btn-success btn-sm py-0 float-left" onclick="applibre('0');"><i class="fa fa-plus"></i> SERV. LIBRE</a></td>
                      <td width="23%">
                        ...
                        <input name="igv" type="hidden" id="igv" value=""/>
                        <h4><input name="ver" type="text" id="ver" class="campo" value=""/></h4>
                      </td>
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="form-group row mb-1">
                    ...
                    <div class="col-sm-3 col-6">
                      <label for="vendedor" class="control-label mb-0">Vendedor</label>
                      <select name="vendedor" id="vendedor" class="form-control form-control-sm" required>
                        <option value="">::Seleccione Vendedor</option>
                        <?php foreach ($vendedores as $vendedor): ?>
                          <?php if ($vendedor->id!=1): ?>
                          <option value="<?php echo $vendedor->id ?>" <?php echo set_value_select($this->session->userdata("id"),'vendedor',$vendedor->id,$this->session->userdata("id")); ?>><?php echo $vendedor->nombres ?></option>
                          <?php endif ?>
                        <?php endforeach ?>
                      </select>
                    </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group row mb-1 mt-2">
                    ...
                    <div class="col-sm-3">
                      <span class="col-form-label" id="puntaje">Puntos Acumulados :</span>
                    </div>
                  </div>
                  ...
                  <div id="contado" style="display: block;">
                    <div class="form-group row mb-1">
                      ...
                      <div class="col-sm-2 col-6">
                        <input name="monto[]" type="text" id="monto1" class="form-control form-control-sm" value="" placeholder="Monto" readonly/>
                      </div>
