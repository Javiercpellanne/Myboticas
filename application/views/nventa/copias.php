                          ...
                          <tr>
                            <td>
                              ...
                              <div class="row">
                                ...
                                <div class="col-sm-1 col-4"><input type="text" name="nlote[]" id="mlote<?php echo $i; ?>" value="" class="campo"/><input type="hidden" name="lote[]" value="<?php echo $producto->lote ?>" class="campo"/></div>
                                ...
                                <div class="col-sm-2 col-4">
                                  ...
                                  <input type="number" name="dscto[]" value="<?php echo $dscto ?>" class="form-control form-control-sm porcentajen" step="0.01" placeholder="(<?php echo $descuento; ?>)Dscto"/>
                                </div>
              ...
              <div class="row">
                    ...
                    <div class="col-sm-3 col-6">
                      ...
                      <select name="vendedor" id="vendedor" class="form-control form-control-sm" required>
                        ...
                        <?php foreach ($vendedores as $vendedor): ?>
                          ...
                          <option value="<?php echo $vendedor->id ?>" <?php echo set_value_select($nventa,'vendedor',$vendedor->id,$nventa->idvendedor); ?>><?php echo $vendedor->nombres ?></option>
                          <?php endif ?>
                        <?php endforeach ?>
                      </select>
                    </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group row mb-1 mt-2">
                    ...
                    <div class="col-sm-7">
                      <div class="input-group">
                        <input name="cliente" type="text" id="cliente" class="form-control form-control-sm" value="<?php echo $nventa->cliente ?>" placeholder="Nombre o Razon Social" onkeydown="return false" readonly>
                        <div class="input-group-append">
                  ...
                  <div id="contado" style="display: block;">
                    <div class="form-group row mb-1">
                      ...
                      <div class="col-sm-2 col-6">
                        <input name="monto[]" type="text" id="monto1" class="form-control form-control-sm" value="<?php echo $nventa->total; ?>" placeholder="Monto" readonly/>
                      </div>
