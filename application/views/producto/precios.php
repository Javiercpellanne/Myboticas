<?php echo form_open(null,array("class"=>"form-horizontal","name"=>"formdatos", "id"=>"formdatos", "onsubmit"=>"enviodatos('".base_url().$this->uri->uri_string()."');", "enctype"=>"multipart/form-data")); ?>
  ...
  <div class="form-group mb-1">
    <b>Solo de podran actualizar Codigo Barra, Precio Caja, Precio Unidad, Precio Blister en base al Id dato que no se debe de modificar</b>
  </div>

  <div class="form-group">
    <a href="<?php echo base_url(); ?>producto/preciosexcel">Descargar formato de ejemplo para importar <i class="fa fa-download"></i></a>
  </div>
