            ...
            <?php echo form_open(null,array("class"=>"form-horizontal","name"=>"form1", "id"=>"form1", "autocomplete"=>"off", "onsubmit"=>"return envioVenta('".base_url()."venta/guardar');")); ?>
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <table>
                    <tr>
                      <td width="27%" align="right"><a class="btn btn-success btn-sm py-0 float-left" onclick="applibre('<?php echo $empresa->vbonificar ?>');"><i class="fa fa-plus"></i> SERV. LIBRE</a> <b>IGV S./</b></td>
                      <td width="23%">
                      ...
                      <td width="21%" align="right"><b>TOTAL S./</b></td>
                      <td width="29%">
