        ...
        <div class="card card-outline card-primary">
          <div class="card-header py-2">
            <ul class="nav nav-pills">
              ...
              <li class="nav-item"><a class="nav-link py-1 ml-1 active" href="<?php echo base_url(); ?>usuario/conectados">Conectados</a></li>
                ...
                <tbody>
                  ...
                  <?php foreach ($listas as $lista) { ?>
                    <tr>
                      ...
                      <td><?php echo $lista->ip; ?></td>
                      <td><?php echo $lista->nombre; ?></td>
                      <td><?php echo $lista->navegador; ?></td>
                      <td><?php echo $lista->soperativo; ?></td>
                      <td><?php echo $lista->dispositivo; ?></td>
